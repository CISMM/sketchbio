...
signals:
   ...
   private:
    ...
    static void VRPN_CALLBACK
        handle_analogs(void *userdata, const vrpn_ANALOGCB a);
    ...
    bool buttonsDown
        [NUM_HYDRA_BUTTONS];  // number of buttons, each with 2 states
                              // 1 = pressed, 0 = not pressed
    double analogStatus
        [NUM_HYDRA_ANALOGS];  // number of analogs and their current values
