...
Subcellular macromolecular modelling for animation is usually done with programs that are difficult to learn use, and which are controlled by keyboard and a 2D mouse. Discussions among collaborators are often done using 2D whiteboard sketches. Many scientists hire professional computer programmers and/or animators and work with them to create models and animations rather than learn the complex programs.  This both slows the discovery process and provides opportunities for misunderstanding.  Our aim is to provide scientists with a tool that is so rapid to learn and use that they can create these models and animations themselves.
