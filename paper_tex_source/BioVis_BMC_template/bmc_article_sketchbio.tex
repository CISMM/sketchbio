...
\begin{description}
  ...
  \item[$\bullet$ Aid in matching known structures.] Both the fibrin study and the actin/vinculin study aim to produce models that match features seen in electron-microscopy images of molecules.  This requires matching spacing, helicity, and angles with experimentally-determined values.  It also requires the ability to render simulated microscope images in addition to standard surface-based rendering styles.
\end{description}
