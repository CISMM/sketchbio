...
SketchBio provides a set simple operations that is sufficient to meet the animation needs of our driving problems: moving along the video timeline and set keyframes on objects.
...
These values are also exported to Blender with a set of global settings for effects and position of light sources to produce a full-quality rendering.
This simpler user interface allows faster creation of animations without requiring a third party to create them.
