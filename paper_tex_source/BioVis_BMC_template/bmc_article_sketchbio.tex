...
The extent to which the user can control fine-grain maniuplations of the molecules depends on the input device in use, because resolution varies by device. Because some structures have a known transformation from one molecule to the next, SketchBio (like other programs) lets the user input the transformation directly.
...
These novel capabilities can be added to existing molecular modeling tools and included in future tools, providing the same acceleration of model building and evaluation.
