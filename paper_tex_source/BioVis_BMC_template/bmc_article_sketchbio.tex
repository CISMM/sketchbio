...
This work presents SketchBio, a tool for creating models and animations of proteins and other molecular structures.  In order to promote usability, SketchBio is designed to run on a laptop such as a scientist would have and use only commercial hardware that is not cost prohibitive for our users.  The hardware of choice is the Razer Hydra, a pair of six degree of freedom trackers with buttons and high-hats that could be purchased for about \$100.
...
% a possible alternate talking about shadow technique
